...
function mission_data(missionID){
    switch(missionID){
        ...
        case 114: return [6, 0, 0, "水母1 軽1 駆2 火力510 対空440 対潜285 索敵385", "06:30", 100, 130, 500, 500, 1000, 750, "高速修復材×0~4", "改修資材×0~1"]
        // 北方海域
        ...
        case 43: return [6, 55, 300, "護空1[旗艦] 駆2 火力500 対空278 対潜280 索敵220", "12:00", 75, 90, 2000, 0, 0, 400, "開発資材×0~4", "改修資材×0~1"]
        case 44: return [6, 35, 210, "空母2 水母1 軽1 駆2 対潜200 ﾄﾞﾗﾑ缶3隻6個", "10:00", 45, 55, 0, 200, 0, 800, "開発資材×0~4", "家具箱(大)×0~2"]
        ...
        case 132: return [5, 55, 270, "潜水母艦1[旗艦] 潜3 対空89 対潜50", "10:00", 70, 90, 0, 0, 400, 800, "給糧艦「伊良湖」×0~1", "家具箱(大)×0~1"]
        // 南方海域
        ...
        case 141: return [6, 66, 351, "重1[旗艦] 軽1 駆3 火力450 対空420 対潜330 索敵268", "07:30", 100, 0, 0, 600, 600, 1000, "家具箱(大)×0~2", "改修資材×0~1"]
