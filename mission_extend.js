...
function mission_data(missionID){
    switch(missionID){
        ...
        case 102: return [5, 35, 185, "軽1 (駆+海防)3 対空90 対潜280 索敵60", "02:15", 55, 70, 120, 0, 60, 60, "高速修復材×0~1", "開発資材×0~2"]
        ...
        case 13: return [6, 5, 0, "軽1 (駆+海防)4", "04:00", 70, 60, 240, 300, 0, 0, "高速修復材×0~2", "家具箱(小)×0~1"]
        case 14: return [6, 6, 0, "軽1 (駆+海防)3", "06:00", 90, 100, 0, 280, 200, 30, "高速修復材×0~1", "開発資材×0~1"]
        case 15: return [6, 9, 0, "空母2 (駆+海防)2", "12:00", 100, 160, 0, 0, 300, 400, "家具箱(大)×0~1", "開発資材×0~1"]
        case 16: return [6, 10, 0, "軽1 (駆+海防)2", "15:00", 120, 200, 500, 500, 200, 200, "高速建造材×0~2", "開発資材×0~2"]
        case 110: return [6, 40, 150, "水母1 軽1 (駆+海防)2 対空200 対潜200 索敵140", "00:35", 35, 40, 0, 0, 10, 30, "家具箱(小)×0~1", "高速修復材×0~1"]
        case 111: return [6, 45, 220, "重1 軽1 (駆+海防)3 火力360 対潜160 索敵140", "08:40", 70, 130, 300, 200, 100, 0, "開発資材×0~2", "高速修復材×0~2"]
        case 112: return [6, 50, 260, "水母1 軽1 (駆+海防)4 火力400 対潜220 索敵190", "02:50", 50, 70, 0, 100, 100, 180, "家具箱(大)×0~1", "高速修復材×0~2"]
        case 113: return [6, 55, 410, "重2 軽1 (駆+海防)2 潜1 火力500 対潜280", "07:30", 60, 100, 0, 0, 1200, 650, "開発資材×0~4", "改修資材×0~1"]
        // 北方海域
        case 17: return [6, 20, 0, "軽1 (駆+海防)3", "00:45", 30, 40, 70, 90, 50, 0, "", ""]
        case 18: return [6, 15, 0, "空母3 (駆+海防)2", "05:00", 60, 60, 0, 0, 300, 150, "高速修復材×0~1", ""]
        case 19: return [6, 20, 0, "航戦2 (駆+海防)2", "06:00", 60, 70, 400, 50, 50, 30, "家具箱(小)×0~1", "開発資材×0~1"]
        case 20: return [2, 1, 0, "潜1 軽1", "02:00", 40, 50, 0, 0, 150, 0, "開発資材×0~1", "家具箱(中)×0~1"]
        case 21: return [5, 15, 30, "軽1 (駆+海防)4 ﾄﾞﾗﾑ缶3隻", "02:20", 45, 55, 320, 270, 0, 0, "家具箱(小)×0~1", ""]
        case 22: return [6, 30, 45, "重1 軽1 (駆+海防)2", "03:00", 45, 400, 0, 10, 0, 0, "", ""]
        case 23: return [6, 50, 200, "航戦2 (駆+海防)2", "04:00", 70, 420, 0, 50, 0, 130, "家具箱(中)×0~1", ""]
        case 24: return [6, 50, 200, "軽1[旗艦] (駆+海防)4", "08:20", 65, 80, 500, 0, 0, 150, "開発資材×0~2", "高速修復材×0~1"]
        // 南西海域
        case 41: return [3, 30, 100, "(駆+海防)3 火力60 対空80 対潜210", "01:00", 30, 50, 100, 0, 0, 20, "開発資材×0~1", "高速修復材×0~1"]
        case 42: return [4, 45, 200, "軽1 (駆+海防)2", "08:00", 60, 65, 800, 0, 0, 200, "家具箱(大)×0~1", "高速建造材×0~3"]
        case 43: return [6, 55, 301, "護空1[旗艦] 駆2 火力500 対潜280", "12:00", 75, 90, 2000, 0, 0, 400, "開発資材×0~4", "改修資材×0~1"]
        ...
        // 西方海域
        case 25: return [4, 25, 0, "重2 (駆+海防)2", "40:00", 80, 180, 900, 0, 500, 0, "家具箱(中)×0~1", ""]
        case 26: return [4, 30, 0, "空母1 軽1 (駆+海防)2", "80:00", 150, 200, 0, 0, 0, 900, "高速修復材×0~3", "家具箱(大)×0~1"]
        ...
        case 32: return [3, 5, 0, "練巡1[旗艦] (駆+海防)2", "24:00", 300, "？", 50, 50, 50, 50, "家具箱(大)×0~1", "開発資材×0~3"]
        case 131: return [5, 50, 200, "水母1[旗艦] (駆+海防)4 対空240 対潜240 索敵300", "02:00", 35, 45, 0, 20, 20, 100, "高速修復材×0~1", ""]
        case 132: return [5, 55, 274, "潜水母艦1[旗艦] 潜3 (軽or駆or海防)1 対潜50", "10:00", 70, 90, 0, 0, 400, 800, "給糧艦「伊良湖」×0~1", "家具箱(大)×0~1"]
        // 南方海域
        case 33: return [2, 0, 0, "駆2", "00:15", 0, 0, 0, 0, 0, 0, "", ""]
        case 34: return [2, 0, 0, "駆2", "00:30", 0, 0, 0, 0, 0, 0, "", ""]
        case 35: return [6, 40, 0, "空母2 重1 (駆+海防)1", "07:00", 100, 100, 0, 0, 240, 280, "家具箱(小)×0~2", "開発資材×0~1"]
        case 36: return [6, 30, 0, "水母2 軽1 (駆+海防)1", "09:00", 100, 100, 480, 0, 200, 200, "家具箱(中)×0~2", "高速修復材×0~1"]
        case 37: return [6, 50, 200, "軽1 (駆+海防)5 ﾄﾞﾗﾑ缶3隻4個", "02:45", 50, 65, 0, 380, 270, 0, "家具箱(小)×0~1", ""]
        case 38: return [6, 65, 240, "(駆+海防)5 ﾄﾞﾗﾑ缶4隻8個", "02:55", 50, 70, 420, 0, 200, 0, "家具箱(小)×0~1", ""]
        case 39: return [5, 3, 180, "潜水母艦1 潜4", "30:00", 130, 320, 0, 30, 300, 0, "高速修復材×0~2", "家具箱(中)×0~1"]
        case 40: return [6, 25, 150, "軽1[旗艦] 水母2 (駆+海防)2", "06:50", 60, 70, 300, 300, 0, 100, "家具箱(小)×0~3", "高速修復材×0~1"]
