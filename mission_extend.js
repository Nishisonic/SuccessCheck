...
function mission_data(missionID){
    switch(missionID){
        ...
        case 43: return [6, 55, 406, "護空1[旗艦] 駆2 火力500 対潜280", "12:00", 75, 90, 2000, 0, 0, 400, "開発資材×0~4", "改修資材×0~1"]
        ...
        case 132: return [5, 55, 0, "潜水母艦1[旗艦] 潜3 (軽or駆)1", "10:00", 70, 90, 0, 0, 400, 800, "給糧艦「伊良湖」×0~1", "家具箱(大)×0~1"]
        // 南方海域
