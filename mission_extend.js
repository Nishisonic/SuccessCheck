...
function mission_data(missionID){
    switch(missionID){
        ...
        case 100: return [4, 5, 0, "(駆+海防)3", "00:25", 15, 10, 45, 45, 0, 0, "", ""]
        case 101: return [4, 20, 0, "(駆+海防)4 火力50 対空70 対潜180", "00:55", 40, 45, 70, 40, 0, 10, "開発資材×0~1", "高速修復材×0~1"]
        case 102: return [5, 35, 107, "軽1 (駆+海防)3 対空90 対潜280 索敵60", "02:15", 55, 70, 120, 0, 60, 60, "高速修復材×0~1", "開発資材×0~2"]
        ...
        case 111: return [6, 45, 220, "重1 軽1 駆3 火力360 索敵140", "08:40", 70, 130, 300, 200, 100, 0, "開発資材×0~2", "高速修復材×0~2"]
        case 112: return [6, 50, 270, "水母1 軽1 駆4 火力400 対潜220 索敵190", "02:50", 50, 70, 0, 100, 100, 180, "家具箱（大）×0~1", "高速修復材×0~2"]
        case 113: return [6, 55, 437, "重2 軽1 駆2 潜1 火力500 対潜280", "07:30", 60, 100, 0, 0, 1200, 650, "開発資材×0~4", "改修資材×0~1"]
        // 北方海域
        ...
        case 21: return [5, 15, 30, "軽1 駆4 ドラム缶3/3", "02:20", 45, 55, 320, 270, 0, 0, "家具箱(小)×0~1", ""]
        case 22: return [6, 30, 45, "重1 軽1 駆2", "03:00", 45, 400, 0, 10, 0, 0, "", ""]
        case 23: return [6, 50, 200, "航戦2 駆2", "04:00", 70, 420, 0, 50, 0, 130, "家具箱(中)×0~1", ""]
        case 24: return [6, 50, 200, "軽1 (駆+海防)4", "08:20", 65, 80, 500, 0, 0, 150, "開発資材×0~2", "高速修復材×0~1"]
        // 南西海域
        ...
        case 43: return [6, 55, 406, "護空1 (駆+海防)2 火力500 対潜280", "12:00", 75, 90, 2000, 0, 0, 400, "開発資材×0~4", "改修資材×0~1"]
        case 44: return [6, 35, 210, "空母2 水母1 軽1 駆2 対潜200 ドラム缶6/3", "10:00", 45, 55, 0, 200, 0, 800, "開発資材×0~4", "家具箱(大)×0~2"]
        case 45: return [5, 51, 271, "軽母1 (駆+海防)4 対空240 対潜300 索敵180", "03:20", 35, 40, 40, 0, 0, 220, "家具箱(中)×0~1", ""]
        // 西方海域
        ...
        case 32: return [3, 5, 0, "練巡1 駆2", "24:00", 300, "？", 50, 50, 50, 50, "家具箱(大)×0~1", "開発資材×0~3"]
        case 131: return [5, 50, 0, "水母1 駆4 対潜240 索敵300", "02:00", 35, 45, 0, 20, 20, 100, "高速修復材×0~1", ""]
        case 132: return [5, 55, 0, "潜水母艦1 潜3", "10:00", 70, "？", 0, 0, 400, 800, "給糧艦「伊良湖」×0~1", "家具箱(大)×0~1"]
        // 南方海域
        ...
        case 37: return [6, 50, 200, "軽1 駆5 ドラム缶4/3", "02:45", 50, 65, 0, 380, 270, 0, "家具箱(小)×0~1", ""]
        case 38: return [6, 65, 240, "駆5 ドラム缶8/4", "02:55", 50, 70, 420, 0, 200, 0, "家具箱(小)×0~1", ""]
        case 39: return [5, 3, 180, "潜水母艦1 潜4", "30:00", 130, 320, 0, 30, 300, 0, "高速修復材×0~2", "家具箱(中)×0~1"]
        case 40: return [6, 25, 150, "軽1 水母2 駆2", "06:50", 60, 70, 300, 300, 0, 100, "家具箱(小)×0~3", "高速修復材×0~1"]
